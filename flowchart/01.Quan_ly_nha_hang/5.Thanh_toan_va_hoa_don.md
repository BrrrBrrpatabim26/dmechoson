...
- Tính đúng tiền: tiền món theo giá chốt, giảm giá đúng hạn mức, thuế và phí đúng cấu hình.
- Linh hoạt tách hóa đơn theo người trả và gộp bàn khi khách đổi chỗ.
...
- Gộp bàn chỉ áp dụng cho đơn đang mở, giữ giá chốt cũ.
...
- Tách và gộp: nhận danh sách dòng món hoặc danh sách đơn; trả về cấu trúc hóa đơn mới.
